        ...
        <div class="grid grid-cols-12 gap-5">
            ...
            <div class="col-span-12 md:col-span-8 bg-white rounded-md shadow relative h-[370px]">
                <div class="flex items-center justify-between p-3 border-b font-iranyekan-bold " x-data="{modal:false}">
                    ...
                    <div class="fixed top-0 left-0 flex items-center justify-center w-screen h-screen p-5 bg-black/60 z-30" x-show="modal"  x-cloak x-transition.opacity>
                        <div class="p-5 bg-white shadow rounded-md mr-20 md:mr-0 w-full md:w-[550px]" >
