<div>
    <div class="border rounded-md shadow-sm">
        <div class="relative z-0">
            <img class="w-full h-48" src="{{asset('assets/images/challenge.png')}}" alt="">
        </div>
        <div class="flex flex-col gap-2 p-3 text-base ">
            ...
            <div class="flex items-center justify-between text-sm font-bold my-1">
                ...
                <div class="flex gap-3">
                    <div class="flex items-center gap-1 px-2 py-1 text-[10px] text-white bg-yellow-600 rounded-2xl font-light">
                        <img src="{{asset('assets/images/icons8_time.svg')}}" alt="" class="z-0">
                        <span>
                            سابمیشن شما در دست بررسی است
                        </span>
                    </div>
                </div>
            </div>
